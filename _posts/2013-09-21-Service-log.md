...
![Selecting 'Email reminders'](/assets/images/tb/log_02.png)  
The service details can be given on time-basis :
* ![Selecting 'Email reminders'](/assets/images/tb/log_03.png)  
or it can be given on service-basis :
* ![Selecting 'Email reminders'](/assets/images/tb/log_04.png)  
By clicking on the bottom link- *Customize service task*, we can manage the available services.  
We can **Edit** or **Delete** them.  
![Selecting 'Email reminders'](/assets/images/tb/log_05.png)  
New and different services can be added.
![Selecting 'Email reminders'](/assets/images/tb/log_06.png)  
